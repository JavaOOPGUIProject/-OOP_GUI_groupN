...
public class LoginFrame extends JFrame{
    ...
    public LoginFrame(){
        ...
        Title_rest.setFont(new Font("Arial",Font.BOLD,30));
        ...
        bottom_T.setFont(new Font("Arial",Font.BOLD,18));
        ...
        rightpanel.setBorder(new javax.swing.border.EmptyBorder(0, 40, 0, 0));
        ...
        username_field.setMaximumSize(new Dimension(250, 30));
        username_field.setPreferredSize(new Dimension(250, 30));
        ...
        password_field.setMaximumSize(new Dimension(250, 30));
        password_field.setPreferredSize(new Dimension(250, 30));
        ...
        Lecturer_button.setSize(100,20);
        setLocation(500,300);
